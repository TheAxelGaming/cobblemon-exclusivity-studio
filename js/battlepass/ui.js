    ...
    function renderWizard() {
        ...
        if (wizardStep === 1) {
            ...
            const catLabels = {
                ...
                utility: 'Utilidad',
                pokeballs_special: 'Pokeballs Especiales',
                gems: 'Gemas de Tipo',
                fossils: 'Fosiles',
                tumblestones: 'Tumblestones',
                berries_advanced: 'Bayas Avanzadas',
                sweets_mochi: 'Dulces / Mochis',
                candy_misc: 'Caramelos Varios',
                ev_training: 'Entrenamiento EV',
                medicine_extra: 'Medicina Avanzada',
                fishing_rods: 'Canas de Pescar',
                food_ponigiri: 'Ponigiri',
                food_other: 'Comida',
                poke_puffs: 'Poke Puffs',
                aprijuice: 'Aprijuice',
                apricorns: 'Bonguri / Apricorns',
                apricorn_crafts: 'Crafts de Apricorn',
                mulch: 'Mantillo / Mulch',
                mint_materials: 'Materiales de Mentas',
                cooking_pots: 'Ollas de Cocina',
                competitive_extra: 'Competitivo Extra',
                held_extra: 'Equipables Extra',
                evolution_extra: 'Evolucion Extra',
                pokedex_variants: 'Variantes Pokedex',
                sherds_templates: 'Fragmentos / Plantillas',
                misc_held: 'Miscelaneo',
                cobblemon_cosmetic: 'Cosmeticos Cobblemon'
            };
